# Deobfuscated by Darkstar boii sahil
...
folder_path = "/sdcard/AUTO_CREATE_CHAND"
if not os.path.exists("/sdcard/"):
    folder_path = "AUTO_CREATE_CHAND"
try:
...
# ------------------[ CONNECTION MONITOR ]-------------------#
# ------------------[ WHATSAPP CHANNEL ]-------------------#
WHATSAPP_CHANNEL = "https://whatsapp.com/channel/0029VbDCbX68kyyMqK0X1G0p"
...
def approval():
    ...
    sp("\033[1;39m━▷ You Get Approved for Using Command Free Tool \033[1;37m")
    ...
    try:
        github_urls = [
            "https://chandtricks.link/raw/project/auto-fb-create-approve",
        ...
        if approved:
            ...
            print(f"\n\033[1;32m━▷ Visit: \033[1;36mhttps://chandtricks.link/")
            print(f"\033[1;32m━▷ Enter your key in the web to get approved")
            print(f"\033[1;32m━▷ Your Key: \033[1;36m{id}\033[1;37m")

            x = input('\n\033[1;33mPress ENTER to open website or type "exit" to quit: ')
            if x.lower() == "exit":
                exit("\033[1;32m━▷ Thanks for trying CHAND TOOL!")

            print(f"\033[1;32m━▷ Opening website...")
            open_url("https://chandtricks.link/")

            print(f"\033[1;32m━▷ Enter this key on website: \033[1;36m{id}")

            input("\n\033[1;33mAfter approval, press ENTER to check again...")
            return approval()
...
# ------------------[ LOGO ]-------------------#
logo = f"""\033[1;37mWELCOME TO CHAND COMMAND
...
\033[1;39m━▷ \033[0;91m𝙒𝙀𝘽𝙎𝙄𝙏𝙀  \033[1;39m◈✙◈ \033[1;33mchandtricks.com
...
# ------------------[ YOUTUBE CHANNEL ]-------------------#
YOUTUBE_CHANNEL = "https://www.youtube.com/@chandtricker"
...
def auto_create_fb_method_1_() -> None:
    ...
    for make in range(50000):
        ...
        sys.stdout.write(
            f"\r\r\033[1;37m<[{boos}CHAND-TRICKER\033[1;37m]<🖤>[{make + 1}|\033[1;32m{oks}\033[1;37m]> "
        )
        sys.stdout.flush()
        ...
        if "c_user" in py_submit.cookies:
            ...
            # linex()
            file_path_ok = os.path.join(folder_path, "CHAND-CREATE-OK.txt")
...
def auto_create_fb_method_2_() -> None:
    ...
    for make in range(1000):
        sys.stdout.write(
            f"\r\r\033[1;37m<[{boos}CHAND-TRICKER\033[1;37m]<🖤>[{make + 1}|\033[1;32m{len(ok)}\033[1;37m]> "
        )
        sys.stdout.flush()
        ses = requests.Session()
        fake = Faker()
...
# ------------------[ METHOD 3 SPREAD UID ]-------------------#
SPREAD_FOLDER = "SPREAD-UID-CHAND"
